	...
	<div class="super_container">
		...
		<div class="features">
			<div class="container" id="searchresult">
				...
				<div class="grammarContainer"></div>
						...
						<div class="col-lg-4 about_col about_col_left ">
							<div class="about_item">
								<div class="about_item_image">
									<a href="ExaminationQuestionForward?index=${index}&pageid=0">
									<img style="height: 225px; width: 225px;" src="${exam.getExaminationimage()}" alt="">
									</a>
								</div>

								<div class="about_item_title">

									<a href="ExaminationQuestionForward?index=${index}&pageid=0">${exam.getExaminationname()}</a>
					...
					<div class="col-lg-4">
						<ul
							...
							<c:if test="${pageid == 1 && pageid != maxpage}">
								...
								<div class="col text-center">
									<div class="load_more trans_200">
										<a href="ExaminationForward?pageid=${pageid+1}">Next</a>
									</div>
								</div>
							</c:if>
							<c:if test="${pageid == maxpage && pageid != 1}">
								...
								<div class="col text-center">
									<div class="load_more trans_200">
										<a href="ExaminationForward?pageid=${pageid-1}">Previous</a>
									</div>
								</div>
								<div class=" col text-center">
									<div class="disabled load_more trans_200">
